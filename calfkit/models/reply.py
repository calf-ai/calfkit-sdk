...
class FaultMessage(_ReplyBase):
    ...
    through a fan-out close: the close re-enters on a ``ReturnMessage``, and the durable basestate
    ...
    (deliberately undecided) receiver-policy choice without a wire migration. Decode-tolerant
    default: an old producer's fault reads as not-elided."""
