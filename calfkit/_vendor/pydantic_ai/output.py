...
class NativeOutput(Generic[OutputDataT]):
    ...
    from . import Agent, NativeOutput
...
class PromptedOutput(Generic[OutputDataT]):
    ...
    from . import Agent, PromptedOutput
...
def StructuredDict(
    ...
    from . import Agent, StructuredDict
