...
- [MCP Adaptor](docs/mcp-adaptor-design.md) — first-class wrapper exposing any MCP server's tools as native calfkit tools, with `mcp.json` interop and zero new mental model
